...
## Future projects
Once that I have a bit more time, I would love to do certain projects that have been in my mind for a long time.

- Read the thesisses of current year's students in computer science: more specifically the students that I know and are still at the KULeuven, or friends who do phd in computer science. I would love to read a lot, especially those that belong to the same research I did (symbolic AI) or general machine learning. I am also interested in reading the thesis and previous works of my mentors.
- Make a generative audio model, and research what all the possibilities are: This I somewhat did on and off in my free time recently, and I ended with settling with the wavenet architecture (because convolutional networks in a pyramid on sample level is a cool concept), but I want to do some things on the spectral domain too.
- Program my own neural network and optimiser
- Use the programs of my thesis to solve other problems
- Use all the KULeuven neuro symbolic AI software once (for example problog, deepproblog etc.).
- Make an audio classifier to classify the style of certain music in my library
